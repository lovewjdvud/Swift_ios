...
// MARK: protocol MedicineAllModelProtocol
protocol MedicineAllModelProtocol{
...
// MARK: MedicineAllModel class
class MedicineAllModel{
    var delegate: MedicineAllModelProtocol!
    var urlPath = share.url("medicine_all_schrodinger.jsp")
